...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DPSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///
/// \endcode
SWIFT_CLASS("_TtC5DPSDK7Gateway")
...
@interface Gateway (SWIFT_EXTENSION(DPSDK)) <NSURLSessionDelegate>
...
SWIFT_CLASS("_TtC5DPSDK29Gateway3DSecureViewController")
